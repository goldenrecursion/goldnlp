...
Our models will also be hosted in in our [golden-models](https://github.com/goldenrecursion/golden-models) repository and [Hugging Face's Model Hub](https://huggingface.co/Golden-AI).
...
Get started with running inference on our custom trained named-entity recognition models.
